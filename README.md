...
- script.js just has some ease of life stuff

## Roadmap:

- [x] More sections!
- [x] More links to my socials
- [ ] A public forum board (THIS IS CANCELLED I DONT WANNA IMPLEMENT THIS, this is because the goal is SWP and introducing too much off-site resources can make it more complex. I want people to be able to take my project and be like "yeah, I get this.")
